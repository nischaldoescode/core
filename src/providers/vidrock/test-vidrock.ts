// test-vidrock.ts
// quick test script for vidrock provider
...
function printResult(
    ...
    result: Awaited<ReturnType<VidRockProvider['getMovieSources']>>
) {
    console.log('\n========================================');
    console.log(`${label}`);
...
async function runTests() {
    ...
    console.log('[init] starting vidrock provider tests');
    ...
    const movieQuery = 'Karthik Calling Karthik';
